...
| TASK-083 | Copy button on listing cards — copy without clicking through | ⚠️ SCREENSHOT REJECTED | Code complete. Build ✅ Lint ✅ HTTP 200 ✅. Screenshot task083_rules.png was too small/dark to clearly identify copy icon vs arrow icon — PM passed on inference rather than visual confirmation. New screenshot required: zoomed in, copy icon clearly distinguishable on a card. |
