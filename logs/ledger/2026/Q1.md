...
| TASK-098 | /learn/ comparison pages — antigravity vs competitors | ⏳ PENDING (Phase 3 — after traffic) | External review suggested deleting. PM verdict (2026-03-31): KEEP but defer. First principles: "Antigravity vs Cursor" IS the dominant search query during the quota crisis (people actively evaluating switching). This is high-intent content. HOWEVER: it belongs in Phase 3 (after PSEO 2.0 and blog), not Phase 1. Do not build until TASK-121/122/123 complete and traffic > 500/month. |
