  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
        {/* Free Tier */}
        <div className="rounded-3xl border border-slate-200 bg-white p-8 flex flex-col relative group hover:border-slate-300 transition-all shadow-sm">
          <div className="mb-8">
          ...
          <button 
            ...
            className="w-full py-4 bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold rounded-xl transition-all border border-slate-200"
          >
            Submit for Free
          </button>
        </div>
        ...
        {/* Standard Tier */}
        <div className="rounded-3xl border border-emerald-500/20 bg-white shadow-sm p-8 flex flex-col relative group hover:border-emerald-500/40 transition-all overflow-hidden">
          <div className="absolute top-0 right-0 bg-emerald-50 px-4 py-1 rounded-bl-xl border-l border-b border-emerald-100">
            <span className="text-xs font-bold text-emerald-600 uppercase tracking-wider">Fast Track</span>
          </div>
          ...
          <div className="mb-8 relative z-10">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Standard Boost</h3>
            <div className="flex items-baseline gap-1">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-emerald-50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

          <button 
            onClick={() => openCheckout('STANDARD')}
            className="relative z-10 w-full py-4 bg-emerald-100 hover:bg-emerald-200 text-emerald-900 font-black rounded-xl transition-all"
          >
            Get Verified
          </button>
        </div>
        ...
        {/* Featured Tier */}
        <div className="rounded-3xl border border-blue-500/50 bg-white p-8 flex flex-col relative group hover:border-blue-500/80 transition-all overflow-hidden transform hover:-translate-y-1 shadow-md">
          <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-blue-400 via-indigo-500 to-blue-400" />
          <div className="absolute top-0 right-0 bg-blue-600 text-white px-4 py-1 rounded-bl-xl shadow-sm">
          ...
          <div className="mb-8 relative z-10">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Featured Sponsor</h3>
            <div className="flex items-baseline gap-1">
          ...
          <button 
            ...
            className="relative z-10 w-full py-4 bg-slate-900 text-white font-black rounded-xl transition-all hover:bg-slate-800 shadow-md"
          >
            Become a Sponsor
          </button>
        </div>
