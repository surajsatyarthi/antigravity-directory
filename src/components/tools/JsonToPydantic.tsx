        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative flex-1">
            <textarea
              ...
              className={`w-full h-full p-4 font-mono text-xs bg-slate-900/50 border rounded-xl outline-none resize-none transition-all text-slate-900 placeholder:text-slate-600 ${error ? 'border-red-500 focus:ring-red-500' : 'border-slate-700 focus:ring-2 focus:ring-amber-500'}`}
            />
            {error && (
