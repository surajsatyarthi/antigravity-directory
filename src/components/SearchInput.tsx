  ...
  return (
    <div className={cn("flex-1 relative", variant === 'hero' ? "max-w-2xl mx-auto" : "max-w-3xl")}>
      ...
      <input
        ...
        className={cn(
          "w-full bg-white border border-slate-200 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-all text-slate-900 placeholder:text-slate-400 outline-none shadow-sm",
          variant === 'hero' 
            ? "pl-14 pr-6 py-5 text-lg rounded-2xl shadow-md" 
