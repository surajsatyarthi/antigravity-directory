  ...
  return (
    <div className={cn("flex-1 relative", variant === 'hero' ? "max-w-2xl mx-auto" : "max-w-3xl")}>
      <Search className={cn(
        ...
        isPending ? 'text-blue-500 animate-pulse' : 'text-slate-500'
      )} />
      <input
        type="text"
        value={query}
        ...
        className={cn(
          "w-full bg-white/[0.06] border border-white/[0.08] focus:border-white/[0.25] transition-all text-white placeholder:text-gray-500 outline-none",
          variant === 'hero' 
