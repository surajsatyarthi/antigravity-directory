    ...
    <div className="relative inline-block text-left">
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          disabled={isPending}
          className="appearance-none bg-transparent text-xs font-bold text-slate-900 uppercase tracking-widest outline-none pr-6 cursor-pointer hover:text-blue-500 transition-colors"
        >
