...
export function CitationBlock({ data }: CitationBlockProps) {
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 mb-12 relative overflow-hidden group shadow-sm">
      {/* Decorative Gradient */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-white border border-slate-200 rounded-xl shadow-sm">
            <div className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mb-1">Entity Type</div>
            <div className="text-xs text-slate-900 font-mono font-bold truncate">{data.category}</div>
          </div>
          <div className="p-4 bg-white border border-slate-200 rounded-xl shadow-sm">
            <div className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mb-1">Trust Signal</div>
          ...
          <div className="p-4 bg-white border border-slate-200 rounded-xl shadow-sm">
            <div className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mb-1">Score</div>
            <div className="text-xs text-slate-900 font-mono font-bold">{data.rating} / 5.0</div>
          </div>
          <div className="p-4 bg-white border border-slate-200 rounded-xl shadow-sm">
            <div className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mb-1">Visibility</div>
