      ...
      <div className="flex items-center gap-3">
        <div className="hidden lg:flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-1.5 bg-white border border-slate-200 rounded text-white/80 focus:outline-none focus:border-blue-500/30 cursor-pointer text-[11px] font-bold hover:border-slate-200 transition-colors appearance-none min-w-[140px]"
          >
        ...
        <div className="flex items-center gap-3 lg:hidden">
          ...
          <label htmlFor="sort-dropdown" className="text-xs font-black text-slate-400 uppercase tracking-widest hidden sm:inline">Sort Mode:</label>
          <select
            id="sort-dropdown"
            value={currentSort}
            onChange={(e) => handleSortChange(e.target.value)}
            className="px-3 py-2 bg-white border border-slate-200 rounded text-white/80 focus:outline-none focus:border-blue-500/30 cursor-pointer text-sm font-bold hover:border-slate-200 transition-colors appearance-none"
